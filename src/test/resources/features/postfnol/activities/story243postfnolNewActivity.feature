...
And I click update button on New Activity screen for post FNOL
And I will see the "30 day diary adjusted" activity on Workplan screen for post FNOL with Overdue Time "01/03/2019 12:00 AM"
...
And I click update button on New Activity screen for post FNOL
And I will see the "30 day diary" activity on Workplan screen for post FNOL with Overdue Time "now"
