...
Feature: REGRESSION FOR CREATE PAYMENT AND APPROVE
  ...
  And I login to ClaimCenter as role "<cheque creator role>"
    And I Select existing Claim "300000007"
    ...
    And I select the activity for subject "Review and approve new payment" for claim "300000007" for insured "Steve Knight-itb1" and for exposure "S99SJA - Steve Knight-itb1 - 1st Party Vehicle"
   ...
   And I login to ClaimCenter as role "<cheque creator role>"
    ...
    Examples: 
      | cheque creator role     | amount | cheque approver role |
      | ADClaimsHandlerTm1      |   2.99 | ADTeamManagerTm1     |
