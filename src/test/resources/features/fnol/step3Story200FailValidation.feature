Feature: Validation at step3 of FNOL
  ...
  @Ignore
  Scenario: CBPCL-200  TC10   IncidentType/Cause/Subcause requiring just an INSURED VEHICLE incident will FAIL validation if no INSURED VEHICLE is present
  ...
  @Ignore
  Scenario: CBPCL-200  TC13   IncidentType/Cause/Subcause requiring a INSURED DRIVER incident will FAIL validation if no INSURED DRIVER is present
  ...
  @Ignore @tested
  Scenario: CBPCL-200  TC12   IncidentType/Cause/Subcause requiring a TP VEHICLE incident will FAIL validation if no TP VEHICLE is present
    And I complete step2 for FNOL
  ...
  @Ignore @tested
  Scenario: CBPCL-200  TC12   IncidentType/Cause/Subcause requiring a TP PROPERTY incident will FAIL validation if no TP PROPERTY is present
    And I complete step2 for FNOL
    And I select the insureds vehicle at step3
    And I will be on vehicle screen for FNOL
    And I select "AddDriver" on vehicle screen
  ...
  @Ignore @tested
  Scenario: CBPCL-200  TC12   IncidentType/Cause/Subcause requiring a PEDESTRIAN incident will FAIL validation if no PEDESTRIAN is present
    And I complete step2 for FNOL
    And I select the insureds vehicle at step3
    And I will be on vehicle screen for FNOL
    And I select "AddDriver" on vehicle screen
  ...
  Scenario: CBPCL-200  TC12   IncidentType/Cause/Subcause requiring a TP PROPERTY OWNER incident will FAIL validation if no TP PROPERTY OWNER is present
    And I complete step2 for FNOL
  ...
  Scenario: CBPCL-200  TC12   IncidentType/Cause/Subcause requiring a TP DRIVER incident will FAIL validation if no TP DRIVER is present
    And I complete step2 for FNOL
    And I select the insureds vehicle at step3
    And I will be on vehicle screen for FNOL
    And I select "AddDriver" on vehicle screen
