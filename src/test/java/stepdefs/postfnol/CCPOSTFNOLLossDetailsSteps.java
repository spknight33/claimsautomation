...
public class CCPOSTFNOLLossDetailsSteps extends BaseTest {
	...
	/**
	 * This is for excel driven regression tests, where the update values are held
	 *  and driven from the spreadsheet contents
	 * @throws Throwable
	 */
	@Then("^I change data in the Loss Details screen post FNOL$")
	public void i_change_data_in_loss_details_screen () throws Throwable {
		
	   // This will be driven by what is in the Excel tesdata input sheet
	...
	@Given("^I click add Witness details on post FNOL loss details$")
	public void addWitnessDetails() {
		
		postFnolLossDetailsPOM.addWitnesses();
	}
