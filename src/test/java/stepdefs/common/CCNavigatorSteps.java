...
public class CCNavigatorSteps extends BaseTest {
	...
	public void i_select_on_the_Claim_Navigator(String link) throws Throwable {
		...
		case "TP Care":
			...
			break;
		case "Notes":
			navigatorBarPOM.clickTopLevel("Notes");
			
			break;
		case "Services":
			navigatorBarPOM.clickTopLevel("Services");
			
			break;
		case "History":
			navigatorBarPOM.clickTopLevel("History");
			
			break;
		case "Litigation":
			navigatorBarPOM.clickTopLevel("Litigation");
			
			break;
		case "Documents":
			navigatorBarPOM.clickTopLevel("Documents");
