...
public class ClaimCenterDataBuilder {
	...
	public static ClaimCenterData createRegressionDataSet()
	{
		// hard coded for now - read from config file later
				...
				data.atStep3FNOLPedestrianRequired = true;
				data.atStep3FNOLPropertyRequired= true;
				data.atStep3FNOLTPVehicleRequired= true;
				data.atStep3FNOLPoliceRequired= true;
			    
				data.atStep2FNOLInsuredVehicleRequired= true;
			    
				data.atTPVehicleStep3FNOLDriverRequired= true;
				data.atTPVehicleStep3FNOLPassengerRequired= true;
			    
				data.atPHVehicleStep3FNOLDriverRequired= true;
				data.atPHVehicleStep3FNOLPassengerRequired= true;
