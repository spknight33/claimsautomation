...
public class ClaimCenterPOSTFNOLEditPassengerDetailsPOM extends BaseTest{
	...
	@FindBy(id = "PostFNOLContactPopup:FNOLContactScreen:ContactDV:FNOLContactInputSet:PedestrianOrDriverOrPassengerDetails:PedestrianOrDriverOrPassengerRoleInputSet:WhereWereTheyInTheVehicle_itb-inputEl")
	...
	@FindBy(id = "PostFNOLContactPopup:FNOLContactScreen:ContactDV:InjuryIncidentInputSet:AmbulanceAttended_itb_false-inputEll")
	...
	@FindBy(id = "PostFNOLContactPopup:FNOLContactScreen:ContactDV:InjuryIncidentInputSet:AirAmbulanceAttended_itb_false-inputEll")
	...
	@FindBy(id = "PostFNOLContactPopup:FNOLContactScreen:ContactDV:InjuryIncidentInputSet:HospitalAttended_itb_false-boxLabelEl")
	...
	public void selectOKorUpdate() {
		logger.info(format("%s -  going to click OKorupdate", getName()));
