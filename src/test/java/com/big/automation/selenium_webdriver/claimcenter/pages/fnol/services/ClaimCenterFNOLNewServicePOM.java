package com.big.automation.selenium_webdriver.claimcenter.pages.fnol.services;
...
public class ClaimCenterFNOLNewServicePOM extends BaseTest{


	@FindBy(id = "OtherServiceRequestPopup:ttlBar")
	private WebElement pageTitle;
	
	@FindBy(id = "OtherServiceRequestPopup:Update")
	private WebElement okButton;
	@FindBy(id = "OtherServiceRequestPopup:Cancel")
	private WebElement cancelButton;


	@FindBy(id = "OtherServiceRequestPopup:NewServiceRequestDV:RelatedTo-inputEl")
	private WebElement relatedToDropdown;
	
	
	@FindBy(id = "OtherServiceRequestPopup:NewServiceRequestDV:InstructionServicesLV_tb:AddMultipleServices")
	private WebElement addServiceButton;
	@FindBy(id = "OtherServiceRequestPopup:NewServiceRequestDV:InstructionServicesLV_tb:Remove")
	...
	//TODO service table?
	@FindBy(id = "OtherServiceRequestPopup:NewServiceRequestDV:Kind-inputEl")
	private WebElement requestTypeDropdown;
	
	
	@FindBy(id = "OtherServiceRequestPopup:NewServiceRequestDV:Specialist-inputEl")
	private WebElement vendorNameDropdown;
	@FindBy(id = "OtherServiceRequestPopup:NewServiceRequestDV:Specialist:SpecialistMenuIcon")
	private WebElement vendorNamePickerIcon;
	@FindBy(id = "OtherServiceRequestPopup:NewServiceRequestDV:Specialist:MenuItem_Search-textEl")
	private WebElement vendorNamePickerSearch;
	//TODO other pickers
	
	@FindBy(id = "OtherServiceRequestPopup:NewServiceRequestDV:NewServiceRequestInstructionInputSet:InstructionText-inputEl")
	private WebElement additionalInstructions;
	
	
	@FindBy(id = "OtherServiceRequestPopup:NewServiceRequestDV:NewServiceRequestInstructionInputSet:RequestedServiceCompletionDate-inputEl")
	private WebElement requestedCompletionDate;
	
	@FindBy(id = "OtherServiceRequestPopup:NewServiceRequestDV:NewServiceRequestInstructionInputSet:CustomerContact-inputEl")
	private WebElement customerContactDropdown;
	@FindBy(id = "OtherServiceRequestPopup:NewServiceRequestDV:NewServiceRequestInstructionInputSet:CustomerContact:CustomerContactMenuIcon")
	private WebElement customerContactPickerIcon;
	@FindBy(id = "OtherServiceRequestPopup:NewServiceRequestDV:NewServiceRequestInstructionInputSet:CustomerContact:ClaimNewContactPickerMenuItemSet:NewContactPickerMenuItemSet_NewPerson-itemEl")
	private WebElement customerContactPickerNewPerson;
	//TODO other pickers
	
	
	@FindBy(id = "OtherServiceRequestPopup:NewServiceRequestDV:NewServiceRequestInstructionInputSet:ServiceAddressPicker-inputEl")
	...
	public String getName() {
		...
		return "FNOL Create New Service";
	}
