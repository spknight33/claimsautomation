...
public class ClaimCenterFNOLVehicleDetailsPOM extends BaseTest{
	...
	// Occupants
	@FindBy(id = "FNOLVehicleIncidentPopup:FNOLVehicleIncidentScreen:NoOfOccupants_true-inputEl")
	private WebElement occupantsYesOption;
	@FindBy(id = "FNOLVehicleIncidentPopup:FNOLVehicleIncidentScreen:NoOfOccupants_false-inputEl")
	private WebElement occupantsNoOption;
	@FindBy(id = "FNOLVehicleIncidentPopup:FNOLVehicleIncidentScreen:Vehicle_NoOfOccupants-inputEl")
