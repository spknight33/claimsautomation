...
public class ClaimCenterPOSTFNOLViewPropertyExposurePOM extends BaseTest{
	...
	@FindBy(id = "ExposureDetail:ExposureDetailScreen:ExposureDetailDV:PropertyDamageDV:Claimant_Type-inputEl")
